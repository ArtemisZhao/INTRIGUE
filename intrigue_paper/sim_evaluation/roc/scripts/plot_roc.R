library(pROC)
pdf(file = "results/roc_rep_cefn.pdf", width=8.3, height=8.2, bg="white", pointsize=16)
...
pdf(file = "results/roc_irr_cefn.pdf", width=8.3, height=8.2, bg="white", pointsize=16)
...
pdf(file = "results/roc_rep_meta.pdf", width=8.3, height=8.2, bg="white", pointsize=16)
...
pdf(file = "results/roc_irr_meta.pdf", width=8.3, height=8.2, bg="white", pointsize=16)
